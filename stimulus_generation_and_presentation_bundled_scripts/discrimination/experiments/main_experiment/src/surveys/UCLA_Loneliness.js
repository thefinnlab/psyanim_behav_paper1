const text_list_ucla = [{
    "instructions": "The following statements describe how people sometimes feel. For each statement, please indicate how often you feel the way described by circling one of the responses below. Here is an example: </br> How often do you feel happy? </br>If you never felt happy, you would respond 'Never'; if you always feel happy, you would respond 'Always.'",
}, {
    "questions": [
        ...
        'To check if you are paying attention, select "Always".',
    ...
    "response_choices": ["(1) Never", "(2) Rarely", "(3) Sometimes", "(4) Always"]
}]

export default text_list_ucla;