...
import stimSets from './stimSets_textv.json'; // list of 500 combinations  of trials (in integers)
 ...
 */
const userID = 'playfight_textv_nocoverstory_withwordbetween';
const experimentName = 'pf_textv_nocoverstory_withwordbetween';
...
var response_page = {
    ...
    preamble: "<p style='width:1000px;'><strong>Describe what happened between the dots (if anything) using a word or a short phrase.</strong><br>Guess if you do not know.",
    html: response_text,
    // autofocus: 'Text1_id'
    on_load: function() {
        document.querySelector('input[type="text"]').style.cssText = 'font-size: 24px; width: 400px; height: 40px;';
...
timeline.push({
    ...
    questions: [{
        // prompt: "<style>p{text-align: left;width: 100%;}</style><p><strong> Which of the following did the dots represent?</strong></p>",
        prompt: "<style>p{text-align: left;width: 100%;}</style><p><strong> If you had to guess, which of the following <br>do you think the dots behaved most like?</strong></p>",
        name: 'agents_type',
