...
// let removedItems = stimSets.splice(randomIndex, 1);

// Display the modified JSON object and the removed item
//console.log("Modified JSON object:", stimSets);
...
// timeline.push({
//     type: surveyHtmlForm,
//     preamble: text_list[4].demo_intro,
//     html: "  ",
//     response_ends_trial: true,
//     button_label: "Continue.",
// })
...
var response_page = {
    type: surveyHtmlForm,
    preamble: "<p style='width:1000px;'><strong>Describe what the dots were doing using a word or a short phrase.</strong><br>Guess if you do not know.",
    html: response_text,
    // autofocus: 'Text1_id'
    on_load: function() {
        document.querySelector('input[type="text"]').style.cssText = 'font-size: 24px; width: 400px; height: 40px;';
...
for (let i = 0; i < 7; ++i) {
    ...
    // if (i == 3) { // BREAK EVERY 5 TRIALS, ALSO SAVE DATA INTERIM
    //     var break_screen = {
    //         type: surveyHtmlForm,
